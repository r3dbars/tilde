...
enum ResearchCoordinator {
    ...
    private static let commandHelp: [String: String] = [
        ...
        "ingest-events": "Usage: tilde-lab ingest-events --campaign CAMPAIGN.json --input events.jsonl [--database PATH]",
        "online-report": "Usage: tilde-lab online-report --campaign CAMPAIGN.json [--database PATH] [--json]",
        ...
        "delete-telemetry": "Usage: tilde-lab delete-telemetry --campaign CAMPAIGN.json [--database PATH]",
