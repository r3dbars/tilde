...
- `AutocompleteLabResearch/`: non-shipping experiments, proof harnesses, mocks, and replay behavior.
...
- Keep the shipping app independent from `AutocompleteLabResearch`.
