...
public struct CompatibilityProfileStore: Equatable, Sendable {
    ...
    public static let mvp = CompatibilityProfileStore(profiles: [
        ...
        CompatibilityProfile(
            ...
            supportLevel: .diagnosticsOnly,
            supportReason: "Prompt insertion is blocked until same-slice one-word no-submit proof exists.",
            safetyOwnerNote: "Owner: Codex remains diagnostics-only because accidental prompt submit is high risk and no app-specific no-submit insertion bridge exists yet.",
            renderMode: .disabled,
            insertionMode: .disabled,
            fallbackRenderMode: .disabled,
            fallbackInsertionMode: .disabled,
            ...
            allowsDetachedSuggestions: false,
            isSensitive: true,
            notes: "Dogfood target stays diagnostics-only. Do not insert into prompt editors through generic AX, key events, or clipboard fallback until same-slice screenshot and one-word no-submit proof exists."
        ),
        CompatibilityProfile(
            ...
            supportLevel: .diagnosticsOnly,
            supportReason: "Prompt insertion is blocked until same-slice one-word no-submit proof exists.",
            safetyOwnerNote: "Owner: Claude Code remains diagnostics-only because accidental prompt submit is high risk and no app-specific no-submit insertion bridge exists yet.",
            renderMode: .disabled,
            insertionMode: .disabled,
            fallbackRenderMode: .disabled,
            fallbackInsertionMode: .disabled,
        ...
        CompatibilityProfile(
            ...
            supportLevel: .diagnosticsOnly,
            supportReason: "Prompt insertion is blocked until same-slice one-word no-submit proof exists.",
            safetyOwnerNote: "Owner: Claude desktop remains diagnostics-only because accidental prompt submit is high risk and no app-specific no-submit insertion bridge exists yet.",
            renderMode: .disabled,
            insertionMode: .disabled,
            fallbackRenderMode: .disabled,
            fallbackInsertionMode: .disabled,
