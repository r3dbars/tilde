...
public struct CompatibilityProfileStore: Equatable, Sendable {
    ...
    public static let mvp = CompatibilityProfileStore(profiles: [
        ...
        CompatibilityProfile(
            ...
            appFamily: .nativeAppKit,
            supportLevel: .yellow,
            supportReason: "Enabled through the universal Accessibility path with automatic insertion-failure demotion.",
            renderMode: .inlineAdjacent,
            insertionMode: .axThenKeyEvents,
            fallbackRenderMode: .floatingMirror,
            fallbackInsertionMode: .axValueReplacement,
            ...
            knownFailureModes: ["rich-text compose can expose stale caret geometry"],
            allowsFieldAnchor: true,
            allowsWindowAnchor: false,
            supportsOneWordAcceptance: true,
            supportsFullAcceptance: true,
            allowsDescendantTextFallback: true,
            notes: "Experimental default-on Mail profile. SensitiveTextFieldPolicy remains mandatory; failed insertion verification triggers per-app auto-demotion and the user kill switch remains available."
        ),
        CompatibilityProfile(
        ...
        CompatibilityProfile(
            ...
            appFamily: .chromium,
            supportLevel: .yellow,
            supportReason: "Enabled for prompt editing with prompt-safe filtering and automatic insertion-failure demotion.",
            renderMode: .inlineAdjacent,
            insertionMode: .axValueReplacement,
            fallbackRenderMode: .floatingMirror,
            fallbackInsertionMode: .axValueReplacement,
            fieldIdentityMode: .stableBounds,
            anchorLadder: [.caret, .field],
            knownFailureModes: ["browser fields can contain private content", "prompt composer geometry can drift"],
            allowsFieldAnchor: true,
            allowsWindowAnchor: false,
            supportsOneWordAcceptance: true,
            supportsFullAcceptance: true,
            ...
            allowsSyntheticCaretPlacement: true,
            promptAppSafetyMode: .wordOnly,
            notes: "Experimental default-on prompt/browser profile. Prompt-safe accepted-text filtering and unconditional control-character blocking stay active; auto-demotion and the per-app kill switch contain insertion failures."
        ),
        CompatibilityProfile(
            ...
            allowsSyntheticCaretPlacement: true,
            promptAppSafetyMode: .wordOnly,
            notes: "Experimental default-on ChatGPT profile. Prompt-safe accepted-text filtering and unconditional control-character blocking stay active; auto-demotion and the per-app kill switch contain insertion failures."
        ),
        CompatibilityProfile(
        ...
        CompatibilityProfile(
            ...
            appFamily: .chromium,
            supportLevel: .yellow,
            supportReason: "Real web writing surfaces are enabled; sensitive browser surfaces remain blocked.",
            renderMode: .inlineAdjacent,
            insertionMode: .axThenKeyEvents,
            fallbackRenderMode: .floatingMirror,
            fallbackInsertionMode: .axValueReplacement,
            ...
            allowsDescendantTextFallback: true,
            notes: "Experimental default-on browser profile. Sensitive payment, password, login, address-bar, private-search, and developer-tool matchers remain hard blocked; other real sites use AX with mirror fallback and per-app auto-demotion."
        ),
        CompatibilityProfile(
        ...
        CompatibilityProfile(
            ...
            fallbackInsertionMode: .axValueReplacement,
            anchorLadder: [.caret, .field],
            knownFailureModes: ["WebKit rich-editor geometry varies by site"],
            allowsFieldAnchor: true,
            allowsWindowAnchor: false,
            supportsOneWordAcceptance: true,
            supportsFullAcceptance: true,
            allowsDescendantTextFallback: true,
            notes: "Experimental default-on Safari profile. Sensitive payment, password, login, address-bar, private-search, and developer-tool matchers remain hard blocked; other sites use AX with mirror fallback and per-app auto-demotion."
        ),
        CompatibilityProfile(
            ...
            appFamily: .electron,
            supportLevel: .yellow,
            supportReason: "Enabled through the Electron degraded-mode ladder with automatic insertion-failure demotion.",
            renderMode: .inlineAdjacent,
            insertionMode: .axThenKeyEvents,
            fallbackRenderMode: .floatingMirror,
            fallbackInsertionMode: .keyEvents,
            ...
            notes: "Experimental default-on Slack profile. Accepted text still cannot contain newline, Tab, or control characters; insertion failures auto-demote and the per-app kill switch remains available."
        ),
        CompatibilityProfile(
            ...
            allowsDescendantTextFallback: true,
            promptAppSafetyMode: .notPrompt,
            notes: "Experimental default-on Telegram profile. Accepted text still cannot contain newline, Tab, or control characters; insertion failures auto-demote and the per-app kill switch remains available."
        ),
        CompatibilityProfile(
            ...
            appFamily: .electron,
            supportLevel: .yellow,
            supportReason: "Enabled with synthetic caret placement and key-event insertion for ProseMirror.",
            renderMode: .inlineAdjacent,
            insertionMode: .keyEvents,
            fallbackRenderMode: nil,
            fallbackInsertionMode: .keyEvents,
            ...
            allowsDetachedSuggestions: false,
            allowsSyntheticCaretPlacement: true,
            notes: "Experimental default-on Notion profile modeled on the Obsidian adapter. It is inline-or-hidden, uses synthetic caret placement when needed, and auto-demotes after verification failures."
        ),
        CompatibilityProfile(
            ...
            allowsDescendantTextFallback: true,
            promptAppSafetyMode: .notPrompt,
            notes: "Experimental default-on Discord profile. Accepted text still cannot contain newline, Tab, or control characters; insertion failures auto-demote and the per-app kill switch remains available."
        ),
        CompatibilityProfile(
            ...
            allowsDescendantTextFallback: true,
            promptAppSafetyMode: .notPrompt,
            notes: "Experimental default-on Discord PTB profile. Accepted text still cannot contain newline, Tab, or control characters; insertion failures auto-demote and the per-app kill switch remains available."
        ),
        CompatibilityProfile(
            ...
            allowsDescendantTextFallback: true,
            promptAppSafetyMode: .notPrompt,
            notes: "Experimental default-on Discord Canary profile. Accepted text still cannot contain newline, Tab, or control characters; insertion failures auto-demote and the per-app kill switch remains available."
        ),
        CompatibilityProfile(
            ...
            appFamily: .electron,
            supportLevel: .yellow,
            supportReason: "Enabled in degraded floating mode behind automatic insertion-failure demotion.",
            renderMode: .floatingMirror,
            insertionMode: .keyEvents,
            fallbackRenderMode: nil,
            fallbackInsertionMode: .keyEvents,
            ...
            supportsFullAcceptance: true,
            allowsDescendantTextFallback: true,
            notes: "Experimental default-on Monaco profile. Geometry remains a known risk, so placement is floating, insertion verification auto-demotes failures, and the per-app kill switch remains available."
        ),
        CompatibilityProfile(
