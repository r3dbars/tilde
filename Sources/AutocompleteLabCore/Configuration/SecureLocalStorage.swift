...
/// hold raw text while raw-content dogfood tracing is opted in), caret-region screenshots,
/// and the downloaded model asset. macOS
...
public enum SecureLocalStorage {
    ...
    public static let directoryPermissions = NSNumber(value: Int16(0o700))
    /// Owner-only file permissions (`rw-------`).
    public static let filePermissions = NSNumber(value: Int16(0o600))
    ...
    @discardableResult
    public static func createDirectory(at directory: URL, fileManager: FileManager = .default) -> Bool {
        do {
    ...
    @discardableResult
    public static func ensureFile(at file: URL, fileManager: FileManager = .default) -> Bool {
    ...
    public static func restrictFile(at file: URL, fileManager: FileManager = .default) {
        try? fileManager.setAttributes(
            [.posixPermissions: filePermissions],
            ofItemAtPath: file.path
        )
