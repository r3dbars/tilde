...
public struct VisiblePageContext: Equatable, Sendable {
    ...
    public var promptGuidance: String {
        ...
        Even when the visible context is a conversation with an assistant or chatbot, you only ever continue the USER's side in the user's voice — never produce the other party's reply, and never adopt an AI persona from the visible conversation.
