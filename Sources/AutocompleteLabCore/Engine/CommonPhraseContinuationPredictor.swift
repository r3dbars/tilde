...
public struct CommonPhraseContinuationPrior: Equatable, Sendable {
    ...
    public static let defaultPriors: [CommonPhraseContinuationPrior] = [
        ...
        CommonPhraseContinuationPrior(contextSuffix: "the onboarding screen should make", continuation: "setup feel clear", score: 0.30),
        CommonPhraseContinuationPrior(contextSuffix: "i want this app to feel", continuation: "fast and useful", score: 0.30),
        CommonPhraseContinuationPrior(contextSuffix: "i want this to be", continuation: "easy to use", score: 0.30),
        CommonPhraseContinuationPrior(contextSuffix: "i would like to see if", continuation: "this works", score: 0.30),
        CommonPhraseContinuationPrior(contextSuffix: "this should feel", continuation: "fast and simple", score: 0.30),
        CommonPhraseContinuationPrior(contextSuffix: "does this work", continuation: "well enough", score: 0.30),
