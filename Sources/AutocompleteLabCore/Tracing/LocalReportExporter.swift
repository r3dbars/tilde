...
public struct LocalReportExporter {
    ...
    public func exportPrivacyBundle(limit: Int = 2_000) -> URL? {
    ...
    public func exportRedactedSurvivalReport(limit: Int = 2_000) -> URL? {
        let events = storedEvents(limit: limit)
    ...
    public func exportDebugSurvivalInspector(limit: Int = 2_000) -> URL? {
    ...
    public func exportHTMLReport(limit: Int = 2_000) -> URL? {
        let events = storedEvents(limit: limit)
