...
public enum AutocompleteTracePrivacyFilter {
    ...
    private static let safeTraceSignalValues: Set<String> = [
        ...
        "accepted-obsidian-tab-passthrough-repaired",
        ...
        "stale-request",
        "stale-text",
        "late-result-baselineChanged",
        "late-result-fieldChanged",
        "late-result-suffixChanged",
        "subpixel-noise",
        "survived",
        "survived_typethrough",
        ...
        "type-through-baselineChanged",
        "type-through-mismatch",
        "type-through-missingVisibleSuggestion",
        "type-through-staleField",
        "type-through-textAfterCursorChanged",
        "type-through-unsupportedComposition",
        "optimistic-type-through-mismatch",
