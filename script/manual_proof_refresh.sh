...
declare -a TARGETS=(
  ...
  "obsidian-font-zoom|Obsidian font zoom|Obsidian|md.obsidian|obsidian-font-zoom|full|AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 script/real_app_smoke.sh obsidian-font-zoom --manual-gate"
  "obsidian-markdown-bold|Obsidian Markdown bold|Obsidian|md.obsidian|obsidian-markdown-bold|full|AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 script/real_app_smoke.sh obsidian-markdown-bold --manual-gate"
  "obsidian-markdown-list|Obsidian Markdown list|Obsidian|md.obsidian|obsidian-markdown-list|full|AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 script/real_app_smoke.sh obsidian-markdown-list --manual-gate"
  "obsidian-multiline|Obsidian multiline|Obsidian|md.obsidian|obsidian-multiline|full|AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 script/real_app_smoke.sh obsidian-multiline --manual-gate"
  "obsidian-run-on|Obsidian run-on sentence|Obsidian|md.obsidian|obsidian-run-on|full|AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 script/real_app_smoke.sh obsidian-run-on --manual-gate"
