...
run_blocking "agent guide contract" ./script/check_agent_guide_contract.sh
run_blocking "agent guide contract self-test" bash script/check_agent_guide_contract_self_test.sh
