...
run_blocking "lightweight source budget" python3 script/check_lightweight_budget.py --source-only
run_blocking "lightweight budget self-test" bash script/check_lightweight_budget_self_test.sh
