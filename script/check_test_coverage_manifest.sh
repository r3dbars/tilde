...
require_pattern "Tests/AutocompleteLabCoreTests/InsertionVerificationTests.swift" "literal Tab and selection changes" "Tab literal and selection-change verification coverage"
...
require_pattern "Tests/AutocompleteLabCoreTests/AcceptanceSurvivalClassifierTests.swift" "expected insertion offset" "local survival window coverage"
require_pattern "Tests/AutocompleteLabCoreTests/AcceptanceSurvivalClassifierTests.swift" "Send checkpoint finalizes" "field-send survival finalization coverage"
...
require_pattern "Tests/AutocompleteLabCoreTests/AutocompleteTraceAnalyzerTests.swift" "survival slices and retention clearing" "survival slice and retention proof coverage"
...
require_file "Tests/AutocompleteLabCoreTests/AutocompleteTraceReportGeneratorTests.swift"
require_pattern "Tests/AutocompleteLabCoreTests/AutocompleteTraceReportGeneratorTests.swift" "JSONL export redaction removes raw text" "JSONL report redaction coverage"
require_pattern "Tests/AutocompleteLabCoreTests/AutocompleteTraceReportGeneratorTests.swift" "HTML export redaction removes raw text" "HTML report redaction coverage"
require_pattern "Tests/AutocompleteLabCoreTests/AutocompleteTraceReportGeneratorTests.swift" "Visual calibration report uses redacted geometry" "screenshot-free visual report coverage"
require_pattern "Tests/AutocompleteLabCoreTests/AutocompleteTraceAnalyzerTests.swift" "insertion reliability by app and mode" "per-app insertion-mode reliability coverage"
...
require_pattern "Tests/AutocompleteLabCoreTests/AutocompleteTraceReportGeneratorTests.swift" "Debug survival inspector" "debug-only survival inspector coverage"
require_file "Tests/AutocompleteLabCoreTests/TracePrivacyFingerprintTests.swift"
require_pattern "Tests/AutocompleteLabCoreTests/TracePrivacyFingerprintTests.swift" "HMAC token" "privacy HMAC fingerprint coverage"
