...
CHUNK_SIZE="${AUTOCOMPLETE_LAB_ENDURANCE_SOAK_CHUNK_SIZE:-20}"
DELAY_MS="${AUTOCOMPLETE_LAB_ENDURANCE_SOAK_DELAY_MS:-120}"
MIN_EVENT_TAP_SAMPLES="${AUTOCOMPLETE_LAB_ENDURANCE_SOAK_MIN_EVENT_TAP_SAMPLES:-500}"
