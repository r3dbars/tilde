...
struct SuggestionAggressivenessTests {
    ...
    func tuningLevelsExposeMoreAggressiveControls() {
        ...
        #expect(veryProactiveTrigger.minimumPhrasePauseDelayMilliseconds == 80)
        ...
        #expect(maxTrigger.minimumPhrasePauseDelayMilliseconds == 20)
        ...
        #expect(max.allowsContinuationDuringTypingBurst)
        #expect(!veryProactive.allowsContinuationDuringTypingBurst)
