...
@Suite("Suggestion overlay native appearance snapshots")
struct SuggestionOverlayNativeAppearanceSnapshotTests {
    @MainActor
    @Test("Suggestion overlay renders under light dark and high contrast appearances")
    func suggestionOverlayRendersUnderNativeAppearances() throws {
    ...
    private func snapshotName(for appearanceName: NSAppearance.Name) -> String {
        ...
        case NSAppearance.Name.aqua.rawValue:
            return "suggestion-overlay-light"
        case NSAppearance.Name.darkAqua.rawValue:
            return "suggestion-overlay-dark"
        case NSAppearance.Name.accessibilityHighContrastAqua.rawValue:
            return "suggestion-overlay-high-contrast-light"
        case NSAppearance.Name.accessibilityHighContrastDarkAqua.rawValue:
            return "suggestion-overlay-high-contrast-dark"
        default:
            return appearanceName.rawValue
                .replacingOccurrences(of: "NSAppearanceName", with: "suggestion-overlay-")
                .lowercased()
        }
    }
}
