...
struct SuggestionSchedulingHostTests {
    ...
    func appDelegateUsesSuggestionSchedulingHost() throws {
        ...
        #expect(host.contains("effectiveFastSelection.suggestion == nil"))
        #expect(host.contains("candidateSelectionSource: wordSelection.selectionSource"))
        ...
        #expect(host.contains("\"instantPhraseAlwaysOn\": \"true\""))
        #expect(!host.contains("fastPhraseFallbackLearningDecision("))
