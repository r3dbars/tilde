...
| Dense candidate picker | 2 | 1 | 4 | 5 | 5 | 1 | 2 | Avoid. It conflicts with Tilde's calm floating suggestion stance. |
...
- On-demand summon mode: useful, but Tilde must preserve Tab as next-word accept. A future shortcut could be "Show once" without taking over Tab.
