...
- [x] Codex has screenshot plus verified one-word no-submit accept in one strict trace slice.
...
- [x] Codex prompt proof verifies one-word accept without submit.
