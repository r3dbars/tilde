...
3. Finish the remaining guarded official Chrome editor lane:
   ...
   web AX target, and still fails honestly when an official page exposes
   too-little-context AX state.
