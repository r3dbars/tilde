...
1. Expand Obsidian coverage with the required variant lanes:
...
3. Add more bounded public text-field domains if the support surface expands beyond the current EditPad and MediumEditor proof paths.
