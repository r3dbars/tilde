...
5. Add production Chrome editor variants after the local real Monaco and ProseMirror caret-quality lanes.
6. Add real production proof paths for Google Docs, Notion, Gmail, ChatGPT,
   Claude web, Codex web, Gemini web, Perplexity web, Copilot web, Poe web,
   browser Slack, browser Discord, Telegram web, Teams web, WhatsApp web, and
   Messenger web before removing their `unsupported-browser-surface` block.
   Action-bearing composer surfaces need no-submit proof first.
