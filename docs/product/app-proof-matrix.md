...
6. Add real production proof paths for Google Docs, Notion, Gmail, ChatGPT,
   Claude web, Codex web, browser Slack, browser Discord, and Telegram web
   before removing their `unsupported-browser-surface` block. Action-bearing
   composer surfaces need no-submit proof first.
