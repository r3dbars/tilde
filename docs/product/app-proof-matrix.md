...
| Browser editor fixtures | A- | [chrome-editor-like.png](visual-placement-screenshots/chrome-editor-like.png), [chrome-monaco-like.png](visual-placement-screenshots/chrome-monaco-like.png), [chrome-prosemirror-like.png](visual-placement-screenshots/chrome-prosemirror-like.png), [chrome-monaco-real.png](visual-placement-screenshots/chrome-monaco-real.png), [chrome-prosemirror-real.png](visual-placement-screenshots/chrome-prosemirror-real.png) | 2 verified accepts per fixture in the manual smoke log, including `monaco-real-default` at 2026-05-08T12:27:47Z and `prosemirror-real-default` at 2026-05-08T12:28:08Z | Good proof for CodeMirror-like, Monaco-like, ProseMirror-like, real Monaco, real ProseMirror, and default-Chrome AX exposure for both real-engine fixtures. Obsidian now has its own real CodeMirror row. | Default-Chrome real-engine proof still falls back to medium-confidence synthetic caret/floating mirror placement, and production editor variants are still missing. |
...
5. Improve real Chrome editor placement from default-Chrome synthetic-caret/floating-mirror proof to caret-quality placement, then add production editor variants.
