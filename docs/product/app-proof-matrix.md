...
3. Run the guarded official Chrome editor lanes: `codemirror-official`,
   ...
   web AX target, and still fails honestly when the official page exposes
   selected, middle-of-line, or too-little-context AX state.
