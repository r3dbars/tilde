...
| Obsidian theme variant | 100 | Current strict visual proof at 2026-05-09T12:53:37Z with two verified accepts in `ObsidianProofVault` using the Autocomplete Lab Proof theme (`manual-smoke-runs.md`, diagnostics lines 261800-261892, trace lines 64914-64939). | None for this theme lane. | Keep this row green while broader Obsidian variants continue. |
