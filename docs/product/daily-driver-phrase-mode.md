...
suggestion after one disposable context. This keeps the next red bar honest:
rerun until the probe reaches insertion, then either graduate it with verified
no-submit proof or remove it.
