...
- Suggestion orchestrator refactor pass: `swift test --filter
  SuggestionOrchestratorTests` passed 5 focused app tests after moving active
  request ownership, request-ticket gating, fast word-selection delegation, and
  engine delegation behind `SuggestionOrchestrator`.
