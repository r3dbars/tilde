...
3. Test real production Monaco, ProseMirror, and CodeMirror apps, not just local
   fixtures.
4. Add automated post-enable proof so first-run setup can confirm TextEdit
