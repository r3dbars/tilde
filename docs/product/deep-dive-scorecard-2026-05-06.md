...
| Obsidian | 8/10 | [obsidian.png](visual-placement-screenshots/obsidian.png) | Screenshot-backed disposable vault proof now exists, and Obsidian is profiled. | Pending: needs broader vault/editor variants before scoring higher. |
...
| Apple Notes title | 6.5/10 | [notes-title.png](visual-placement-screenshots/notes-title.png) | Title-specific screenshot proof exists and is separated from body/checklist proof. | Pending: needs more title variants before scoring higher. |
| Apple Notes body | 6.5/10 | [notes-body.png](visual-placement-screenshots/notes-body.png) | Body-specific screenshot proof exists and is separated from title/checklist proof. | Pending: needs more body variants before scoring higher. |
| Apple Notes checklist | 6.5/10 | [notes-checklist.png](visual-placement-screenshots/notes-checklist.png) | Checklist-specific screenshot proof exists and is separated from title/body proof. | Pending: needs more checklist variants before scoring higher. |
