...
| Claude Code | 9.7/10 | [claude-code-terminal.png](visual-placement-screenshots/claude-code-terminal.png) | Current bounded strict visual smoke at 2026-05-25T13:56:48Z proves inline Terminal-host placement, one verified Tab one-word accept from a phrase-mode suggestion, verified hardware key-event insertion after Unicode insertion was ignored, and no shell or agent submit on the current app build. The row records diagnostics lines 364600-364662, trace lines 24701-24709, visual `strict-complete`, app proof `app-sha256:d222bab3847ec03698e28a0f4a61a959c5301aaf085e701786c2089e650ee1ff`, and archive proof `archive-sha256:964bc381a1b98103e2a485dbeb5dd8b793a276dd759977ca83df46bb1e8188d4`. The adapter stays proof-only, marker-gated, shell-command guarded, active-output guarded, stale-focus rechecked, host-labelable, pasteboard-disabled in the event-tap path, and full-accept disabled. | Pending: host-labeled iTerm2 and Ghostty proof rows on this Mac; Warp is not installed here; separate full-accept no-submit proof stays blocked. |
