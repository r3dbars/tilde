...
| Obsidian | 8/10 | [obsidian.png](visual-placement-screenshots/obsidian.png) | Bounded screenshot-backed proof now exists with two verified accepts in a disposable vault note. | Pending: rerun after app code changes before treating this branch as beta-current; still needs more real editor variants. |
...
| Apple Notes title | 6.5/10 | [notes-title.png](visual-placement-screenshots/notes-title.png) | Title proof now has its own bounded screenshot-backed slice with two verified accepts. | Pending: rerun after app code changes before treating this branch as beta-current; score stays conservative until the broader Notes support row is updated. |
| Apple Notes body | 6.5/10 | [notes-body.png](visual-placement-screenshots/notes-body.png) | Body proof now has its own bounded screenshot-backed slice with two verified accepts. | Pending: rerun after app code changes before treating this branch as beta-current; score stays conservative until the broader Notes support row is updated. |
| Apple Notes checklist | 6.5/10 | [notes-checklist.png](visual-placement-screenshots/notes-checklist.png) | Checklist proof now has its own bounded screenshot-backed slice with two verified accepts. | Pending: rerun after app code changes before treating this branch as beta-current; score stays conservative until the broader Notes support row is updated. |
