...
| Architecture | 9.2/10 | Core policy, geometry, scoped word memory, trace analysis, privacy expiry, support status, serial AX focused-text reads, AX-health cooldowns, and app-proof command coordination are tested and wired. AppDelegate still owns too much suggestion orchestration. |
