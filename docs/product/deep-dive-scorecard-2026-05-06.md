...
| Obsidian | 8/10 | [obsidian.png](visual-placement-screenshots/obsidian.png) | Bounded screenshot-backed proof now exists with two verified accepts in a disposable vault note. | Rerun after app code changes before treating this branch as beta-current; still needs more real editor variants. |
