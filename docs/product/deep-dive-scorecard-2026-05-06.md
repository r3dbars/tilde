...
terminal-hosted Claude Code, default-Chrome editor placement, and more Obsidian/editor shapes.
...
| Chrome Monaco-like support | 9.4/10 | Fresh local Monaco-like proof verifies insertion, `monaco-real` has isolated renderer-accessibility proof, and `monaco-real-default` now has strict default-Chrome proof at 2026-05-08T12:27:47Z with two verified accepts and current proof fingerprints. The default lane still uses medium-confidence synthetic caret and floating mirror/element placement, so caret-quality placement and production editor variants remain open. |
| Chrome ProseMirror-like support | 9.5/10 | Fresh local ProseMirror-like proof verifies insertion, `prosemirror-real` has isolated renderer-accessibility proof, and `prosemirror-real-default` now has strict default-Chrome proof at 2026-05-08T12:28:08Z with two verified accepts and current proof fingerprints. The default lane still uses medium-confidence synthetic caret and floating mirror/element placement, so caret-quality placement and production editor variants remain open. |
...
| Chrome Monaco-like | 9.4/10 | [chrome-monaco-like.png](visual-placement-screenshots/chrome-monaco-like.png), [chrome-monaco-real.png](visual-placement-screenshots/chrome-monaco-real.png) | Local Monaco-like proof is readable near the caret, and real Monaco now has strict screenshot evidence in both isolated forced-renderer Chrome and default Chrome with Tab and Option-Tab verified. | Pending: caret-quality real Monaco placement and production editor variants; current default-Chrome proof uses medium-confidence synthetic caret and floating mirror/element fallback. |
| Chrome ProseMirror-like | 9.5/10 | [chrome-prosemirror-like.png](visual-placement-screenshots/chrome-prosemirror-like.png), [chrome-prosemirror-real.png](visual-placement-screenshots/chrome-prosemirror-real.png) | Local ProseMirror-like proof is inline, and real ProseMirror now has strict screenshot evidence in both isolated forced-renderer Chrome and default Chrome with Tab and Option-Tab verified. | Pending: caret-quality real ProseMirror placement and production editor variants; current default-Chrome proof uses medium-confidence synthetic caret and floating mirror/element fallback. |
...
- `AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 ./script/real_app_smoke.sh chrome --fixture monaco-real --chrome-accessibility default --skip-build`: passed at 2026-05-08T12:27:47Z with default Chrome Accessibility exposure, strict screenshot evidence, Tab accept, Option-Tab full accept, two verified insertions, and current proof fingerprints. The placement still falls back to medium-confidence synthetic caret/floating mirror.
- `AUTOCOMPLETE_LAB_SCREENSHOT_TRACE=1 ./script/real_app_smoke.sh chrome --fixture prosemirror-real --chrome-accessibility default --skip-build`: passed at 2026-05-08T12:28:08Z with default Chrome Accessibility exposure, strict screenshot evidence, Tab accept, Option-Tab full accept, two verified insertions, and current proof fingerprints. The placement still falls back to medium-confidence synthetic caret/floating mirror.
