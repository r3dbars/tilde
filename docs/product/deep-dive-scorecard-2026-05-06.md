...
| Notes support | 8.8/10 | Notes title, body, and checklist now each have bounded strict visual proof with two verified accepts. More note-window sizes, multiline body cases, nested checklist rows, and mixed-format notes are still needed before this becomes broad Notes support. |
...
| Obsidian support | 8.8/10 | Bounded strict visual proof exists for a disposable Obsidian note with two verified accepts. It still needs more vault/editor variants before being treated as broad Obsidian support. |
...
| Non-annoyance | 9/10 | Esc, typed-over tracking, prefix-family cooldowns, quiet-mode request blocking, repetition suppression, pause control, insertion recovery, native Cmd-Z passthrough, app-specific AX cooldowns, and Settings "why hidden" copy help. Prompt-app proof and a real pause/resume annoyance baseline still block a 10. |
...
| Real-app smoke | 9/10 | TextEdit, core Chrome fixtures, Chrome chat-like no-submit, Obsidian, and Notes title/body/checklist have bounded strict visual proof on the current proof fingerprints. Codex, Claude Code, and Claude desktop remain honest prompt-app insertion/no-submit gaps. |
...
| Obsidian | 8.8/10 | [obsidian.png](visual-placement-screenshots/obsidian.png) | Disposable note proof is screenshot-backed with strict visual trace evidence and two verified accepts. | Pending: more vault, theme, and editor-layout variants. |
...
| Apple Notes title | 8.8/10 | [notes-title.png](visual-placement-screenshots/notes-title.png) | Title-field proof is screenshot-backed with strict visual trace evidence and two verified accepts. | Pending: more note-window sizes and title/body transition variants. |
| Apple Notes body | 8.8/10 | [notes-body.png](visual-placement-screenshots/notes-body.png) | Body-field proof is screenshot-backed with strict visual trace evidence and two verified accepts. | Pending: more multiline and rich-text body variants. |
| Apple Notes checklist | 8.8/10 | [notes-checklist.png](visual-placement-screenshots/notes-checklist.png) | Checklist-row proof is screenshot-backed with strict visual trace evidence and two verified accepts. | Pending: more nested checklist and mixed-format variants. |
