...
nonzero background child exits, and skips retry when launch stalls before the
window-created checkpoint. The current bounded run `20260528T074034Z-ghostty`
proved the preflight repair: it logged
