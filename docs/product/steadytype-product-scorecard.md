...
the working-directory stage, so the current blocker is Ghostty spawning a real
shell/pty before command submission. Ghostty remains unsupported until a
