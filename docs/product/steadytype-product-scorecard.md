...
`20260528T030152Z-ghostty` found the prompt-row suggestion at diagnostics line
`819741`, consumed Tab at `820330`, skipped the session probe at `820362`,
recorded the unchanged global paste baseline at `820365`, and failed closed at
`820409` / `820411` with `keyboard-action handled=false reason=insert-failed`.
