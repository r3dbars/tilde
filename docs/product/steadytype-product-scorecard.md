...
Updated: 2026-05-12.
Base app/source evidence checked through `246ef1c77b42` plus the local safety-proof patch.
Latest beta gate evidence checked on 2026-05-12 with the sampled default-runtime latency selector.
